...
export default function ChatPage() {
  ...
  return (
    <div className="flex h-screen bg-gray-50 relative overflow-hidden">
      ...
      >
        {/* Ultra-Compact Header - Optimized for single screen view */}
        <div className={cn(
        ...
        <div className="flex-1 overflow-hidden relative">
          <ScrollArea 
            ref={scrollAreaRef}
            className="messages-container flex-1 p-1 pb-16"
          ...
          >
            <div className="space-y-1 pb-1">
              {isLoadingMessages ? (
                ...
                messages.map((message) => (
                  ...
                  >
                    <div
                      className={cn(
                        "max-w-xs lg:max-w-md px-2 py-1.5 rounded-xl shadow-sm",
                        message.senderId === "me" 
              ...
              <div ref={messagesEndRef} className="h-1" /> {/* Minimal height */}
            </div>
          </ScrollArea>
          ...
          {!isAtBottom && (
            <Button
              ...
              className="fixed bottom-16 right-2 z-50 rounded-full shadow-lg bg-blue-500 hover:bg-blue-600 text-white p-1.5"
              size="sm"
            >
        ...
        {/* Fixed Footer - Ultra-compact for single screen view */}
        <div 
          className={cn(
            ...
            <div className="flex items-center space-x-1">
              ...
              <div className="flex-1 relative">
                <Input
                  ...
                  className="pr-12 focus:ring-2 focus:ring-blue-500 focus:border-blue-500 text-xs h-8"
                  style={{
